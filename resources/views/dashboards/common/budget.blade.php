    ...
    <div class="col-md-5">
        <div class="vivensi-card" style="padding: 30px; background: #0f172a; color: white; border: none; overflow: hidden; position: relative;">
            ...
            <div style="display: flex; align-items: center; margin-bottom: 25px; position: relative;">
                <img loading="lazy" src="{{ asset('img/bruce/bruceia-icone-fundo-claro.svg') }}" alt="Bruce AI" style="width: 40px; height: 40px; border-radius: 50%; border: 2px solid #3b82f6; padding: 2px; object-fit: cover; margin-right: 12px;" title="Atendimento via Bruce AI 🐶">
