    ...
    <form action="{{ $basePath . '/projects' }}" method="POST">
        ...
        <div style="margin-bottom: 35px;">
            ...
            <div class="form-group">
                <label class="form-label" for="description" style="display: block; margin-bottom: 10px; color: #1e293b; font-weight: 700; font-size: 0.9rem;">Missão & Objetivos</label>
        ...
        <div style="margin-bottom: 35px;">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="form-label" for="status" style="display: block; margin-bottom: 10px; color: #1e293b; font-weight: 700; font-size: 0.9rem;">Status da Missão</label>
