...
<head>
    ...
    <title>Vivensi - Finanças Pessoais e Planejamento</title>
    <link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@300;400;500;600;700;800&display=swap" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" rel="stylesheet">
    <link rel="icon" type="image/png" href="{{ asset('img/logovivensi.png') }}">
    
    <style>
        /* Copied from welcome.blade.php with Common tweaks */
        :root {
            --primary: #4f46e5;       
            --primary-dark: #4338ca;
            --secondary: #0f172a;
            --accent: #2563eb; /* Common Accent Color (Blue) */
            --text-main: #1e293b;
            --text-light: #64748b;
            --bg-light: #f8fafc;
        ...
        .blob-1 { top: -10%; right: -5%; width: 600px; height: 600px; background: #bfdbfe; /* Blue Tint */ opacity: 0.5; } 
        ...
        .feature-icon {
            width: 60px; height: 60px; background: #eff6ff; color: var(--accent);
...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="nav-links">
            ...
            <a href="{{ route('solutions.common') }}" style="color: var(--primary);">Pessoal</a>
        </div>
        <div>
        ...
        <div class="hero-m3-grid">
            <div class="hero-content">
                ...
                <h1 class="hero-display">
                    Organize hoje,<br>
                    <span style="color: var(--accent);">realize amanhã.</span>
                </h1>
                <p class="hero-body">
                    A simplicidade que você precisa com a inteligência que você merece. Domine suas finanças pessoais sem planilhas complicadas.
                </p>
                <div style="display: flex; gap: 15px; flex-wrap: wrap;">
                    <a href="#pricing" class="btn-cta" style="padding: 15px 35px; font-size: 1.1rem;">Ver Planos</a>
                    <a href="{{ route('login') }}" class="btn-outline" style="padding: 15px 35px; background: white;">Conta Grátis</a>
                </div>
            </div>
            <div class="hero-visual" style="text-align: center;">
                <img src="https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?auto=format&fit=crop&q=80&w=600" style="border-radius: 24px; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.25); max-width: 100%; transform: rotate(-2deg); border: 4px solid white;">
            </div>
        </div>
    </section>
    ...
    <section style="padding: 100px 5%; background: white;">
        <div style="text-align: center; margin-bottom: 60px;">
            <h2 style="font-size: 2.5rem; font-weight: 800; color: var(--secondary);">Facilidade no dia a dia</h2>
            <p style="color: var(--text-light);">Controle total na palma da sua mão.</p>
        </div>
        <div class="feature-grid">
            <div class="feature-card">
                <div class="feature-icon"><i class="fas fa-receipt"></i></div>
                <h3>Lançamento Rápido</h3>
                <p style="color: var(--text-light);">Adicione gastos em segundos. Categorização automática para você não perder tempo digitando.</p>
            </div>
            <div class="feature-card">
                <div class="feature-icon"><i class="fas fa-bullseye"></i></div>
                <h3>Metas Reais</h3>
                <p style="color: var(--text-light);">Defina objetivos de economia para a viagem, o carro novo ou a aposentadoria. Acompanhe o progresso visualmente.</p>
            </div>
            <div class="feature-card">
                <div class="feature-icon"><i class="fas fa-chart-pie"></i></div>
                <h3>Visão Clara</h3>
                <p style="color: var(--text-light);">Gráficos que mostram exatamente para onde vai seu dinheiro. Identifique gargalos e corte desperdícios.</p>
            </div>
        </div>
    </section>
    ...
    <section class="pricing-section" id="pricing">
        <div style="text-align: center;">
            <span class="m3-badge" style="color: var(--primary);">Simplicidade</span>
            <h2 style="font-size: 2.5rem; font-weight: 800; color: var(--secondary); margin-top: 10px;">Planos que cabem no bolso</h2>
        ...
        <div class="feature-grid" style="margin-top: 50px;">
            @forelse($plans as $plan)
                <div class="price-card">
                    ...
                    <a href="{{ route('register', ['plan_id' => $plan->id, 'billing_cycle' => 'monthly']) }}" class="btn-cta w-100 btn-subscribe" data-plan-id="{{ $plan->id }}" style="display: block;">Criar Conta</a>
                </div>
            @empty
                <div class="price-card">
                    <h3 style="margin: 0; font-size: 1.5rem; color: var(--secondary);">Grátis</h3>
                    <div class="price-display">
                         R$ 0,00
                         <span class="period">/mês</span>
                    </div>
                    <ul style="list-style: none; padding: 0; text-align: left; margin-bottom: 30px;">
                        <li style="margin-bottom: 12px; color: var(--text-light);"><i class="fas fa-check-circle" style="color: var(--accent); margin-right: 10px;"></i> Acesso Básico</li>
                        <li style="margin-bottom: 12px; color: var(--text-light);"><i class="fas fa-check-circle" style="color: var(--accent); margin-right: 10px;"></i> Lançamentos Manuais</li>
                    </ul>
                    <a href="{{ route('register') }}" class="btn-cta w-100 btn-subscribe" style="display: block;">Começar Grátis</a>
                </div>
            @endforelse
        </div>
    </section>
