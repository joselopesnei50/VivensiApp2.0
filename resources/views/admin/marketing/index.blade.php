        ...
        <div class="vivensi-card p-5">
            <form action="{{ route('marketing.generate') }}" method="POST">
                ...
                <div class="mb-4 text-center">
                    <img loading="lazy" src="{{ asset('img/nova-ideintidade-bruce/BruceIA.png') }}" alt="Bruce AI" style="width: 100px; height: 100px; border-radius: 50%; object-fit: cover; border: 4px solid #e0e7ff;">
