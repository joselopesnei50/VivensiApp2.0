...
<div class="d-flex align-items-start gap-3 mb-4 flex-wrap">
    ...
    <div class="flex-1">
        ...
        <p class="text-muted mb-0 mt-1" style="font-size:.85rem;">Compartilhe conhecimento e engaje sua audiência.</p>
    </div>
</div>
    ...
    <div class="row g-4">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-2">
                        ...
                        <textarea name="content" class="form-control rounded-3 content-area"
                                  placeholder="Escreva seu artigo aqui..." required>{{ old('content') }}</textarea>
        ...
        <div class="col-lg-4">
            ...
            <div class="card border-0 shadow-sm rounded-4 mb-4">
                <div class="card-body p-4">
                    <h6 class="fw-bold mb-3" style="color:#0f172a;font-size:.9rem;">Publicação</h6>
            ...
            <div class="card border-0 rounded-4 tip-card">
                <div class="card-body p-4">
                    ...
                    <ul style="padding-left:18px;margin:0;color:#94a3b8;font-size:.82rem;">
                        <li style="margin-bottom:8px;">Use imagens de alta qualidade para prender a atenção.</li>
                        <li style="margin-bottom:8px;">Títulos com números (ex: "5 Dicas") têm mais cliques.</li>
