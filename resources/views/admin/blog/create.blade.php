...
<div class="header-page" style="margin-bottom: 40px;">
    <div style="display: flex; justify-content: space-between; align-items: center;">
        <div>
            <h2 style="margin: 0; color: #1e293b; font-weight: 800; font-size: 2rem; letter-spacing: -1px;">Novo Artigo</h2>
            <p style="color: #64748b; margin: 5px 0 0 0; font-size: 1.1rem;">Compartilhe conhecimento e engaje sua audiência.</p>
        </div>
        ...
        <div class="col-lg-8">
            <div class="vivensi-card" style="padding: 40px; border-radius: 20px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1); border: 1px solid #e2e8f0; background: white;">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="title" class="form-control-premium title-input" placeholder="Digite um título impactante..." required value="{{ old('title') }}">
                ...
                <div class="mb-5">
                    ...
                    <div class="image-upload-area" id="drop-zone">
                        ...
                        <div class="upload-placeholder" id="placeholder">
                            ...
                            <p class="upload-text"><strong>Clique para enviar</strong> ou arraste sua imagem aqui</p>
    ...
    /* ... existing styles ... */
        <div class="col-lg-4">
            ...
            <div class="vivensi-card mb-4" style="padding: 30px; border-radius: 20px; border: 1px solid #e2e8f0; background: white;">
                <h3 class="card-title-sm">Publicação</h3>
                ...
                <label class="toggle-switch mb-4">
                    ...
                    <span class="toggle-label">Publicar Imediatamente</span>
                </label>
            ...
            <div class="vivensi-card gradient-card" style="padding: 30px; border-radius: 20px;">
                <h3 class="card-title-white"><i class="fas fa-lightbulb"></i> Dicas de Mestre</h3>
                <ul class="tips-list">
                    <li>Use imagens de alta qualidade para prender a atenção.</li>
                    <li>Títulos com números (ex: "5 Dicas") costumam ter mais cliques.</li>
