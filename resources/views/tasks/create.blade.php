    ...
    <form action="{{ $basePath . '/tasks' }}" method="POST">
        ...
        <div style="margin-bottom: 35px;">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="assigned_to" style="display: block; margin-bottom: 10px; color: #1e293b; font-weight: 700; font-size: 0.9rem;">Responsável pela Execução</label>
                        <div style="position: relative;">
        ...
        <div style="margin-bottom: 45px;">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="priority" style="display: block; margin-bottom: 10px; color: #1e293b; font-weight: 700; font-size: 0.9rem;">Nível de Prioridade</label>
