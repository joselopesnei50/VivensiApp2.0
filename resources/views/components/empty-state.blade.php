...
<div style="text-align: center; padding: 60px 20px; background: rgba(255,255,255,0.03); border: 1px dashed rgba(255,255,255,0.09); border-radius: 16px; margin: 20px 0;">
    <div style="width: 80px; height: 80px; background: rgba(99,102,241,0.12); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 20px;">
        <i class="fas {{ $icon }}" style="font-size: 2.5rem; color: #818cf8; opacity: 0.8;"></i>
    </div>
    <h5 style="color: #e2e8f0; font-weight: 800; font-size: 1.2rem; margin-bottom: 8px;">{{ $title }}</h5>
