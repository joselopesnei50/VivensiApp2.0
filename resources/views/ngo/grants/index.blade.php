            ...
            <tr>
                <td colspan="6">
                    <x-empty-state 
                        ...
                        title="Sem Editais no Radar" 
                        description="Nenhum convênio ou edital registrado. Comece a monitorar suas fontes de recursos agora." 
                        action_label="Cadastrar Edital" 
