            ...
            <div class="vivensi-card" style="background: #1e293b; border-radius: 28px; padding: 35px; flex-grow: 1; position: relative; overflow: hidden;">
                <div class="bruce-glass-premium">
                    <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 20px;">
                        <img loading="lazy" src="{{ asset('img/bruce/bruceia-icone-fundo-claro.svg') }}" alt="Bruce" style="width: 50px; height: 50px; border-radius: 50%; border: 2px solid white; box-shadow: 0 5px 15px rgba(0,0,0,0.2);">
                        <div>
