...
<form action="{{ route('ngo.email_campaigns.store') }}" method="POST">
@csrf
<div class="row g-4">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-12">
                    ...
                    <input type="email" name="reply_to_email" value="{{ old('reply_to_email') }}"
                           placeholder="diretoria@suaorganizacao.org.br"
                           style="width:100%; padding:13px 16px; border:2px solid #f1f5f9; border-radius:12px; font-size:0.9rem; box-sizing:border-box;">
                </div>
            </div>
        </div>
    ...
    <div class="col-lg-4">
            ...
            @php
                $audiences = [
                    ...
                    'donors' => [
                        ...
                        'desc'  => 'Todos os doadores cadastrados com e-mail',
                        'color' => '#059669',
                        'bg'    => '#ecfdf5',
                    ],
                    'donors_optins' => [
        ...
        <div style="background:#eff6ff; border:1px solid #bfdbfe; border-radius:16px; padding:18px 20px; margin-bottom:20px;">
            <div style="font-weight:800; color:#1d4ed8; font-size:0.83rem; margin-bottom:8px;">
                <i class="fas fa-shield-halved me-2"></i>Dica LGPD
            </div>
            <p style="color:#1e40af; font-size:0.78rem; line-height:1.7; margin:0;">
                Prefira <strong>"Doadores com Opt-in"</strong> para comunicações de marketing.
                Inclua sempre uma forma fácil de descadastramento no corpo do e-mail.
            </p>
        </div>
        ...
        <div class="vivensi-card" style="padding:28px; border-radius:20px; margin-bottom:20px;">
            ...
            <p style="color:#64748b; font-size:0.78rem; margin:0 0 14px; line-height:1.6;">
                ...
                Formato aceito: <code style="font-size:0.72rem; background:#f1f5f9; padding:2px 5px; border-radius:4px;">email@exemplo.com</code>
...
function insertTemplate() {
    const orgName = '{{ auth()->user()->tenant->name ?? "Organização" }}';
...
<table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:16px;overflow:hidden;border:1px solid #e2e8f0;">
  <tr><td style="background:linear-gradient(135deg,#059669,#047857);padding:36px;text-align:center;">
    <h1 style="color:#fff;margin:0;font-size:26px;font-weight:800;">${orgName}</h1>
  </td></tr>
  <tr><td style="padding:40px;">
    <h2 style="color:#0f172a;margin:0 0 16px;font-size:22px;font-weight:700;">Olá, parceiro! 💙</h2>
    <p style="color:#475569;font-size:15px;line-height:1.7;margin:0 0 20px;">
      Gostaríamos de compartilhar as últimas novidades da nossa organização com você.
    </p>
    <p style="color:#475569;font-size:15px;line-height:1.7;margin:0 0 20px;">
      <!-- Escreva o conteúdo principal aqui -->
    </p>
    <div style="text-align:center;margin:30px 0;">
      <a href="#" style="background:#059669;color:#fff;padding:14px 28px;text-decoration:none;border-radius:8px;font-weight:700;display:inline-block;">
        Saiba Mais
      </a>
    </div>
    <p style="color:#64748b;font-size:14px;line-height:1.7;margin:0;">
      Com gratidão,<br><strong>${orgName}</strong>
    </p>
  </td></tr>
  <tr><td style="background:#f1f5f9;padding:24px;text-align:center;font-size:12px;color:#64748b;border-top:1px solid #e2e8f0;">
    ...
    <p style="margin:0;">Para descadastrar-se, responda este e-mail com o assunto "Descadastrar".</p>
  </td></tr>
</table>
</td></tr></table>
</body></html>`;
