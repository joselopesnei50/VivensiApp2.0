...
<head>
    ...
    <title>404 — Página não encontrada | Vivensi</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .code { font-size: 6rem; font-weight: 800; background: linear-gradient(135deg, #4f46e5, #818cf8); -webkit-background-clip: text; -webkit-text-fill-color: transparent; line-height: 1; }
