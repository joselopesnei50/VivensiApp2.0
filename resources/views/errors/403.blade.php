...
<head>
    ...
    <title>403 — Acesso negado | Vivensi</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .code { font-size: 6rem; font-weight: 800; background: linear-gradient(135deg, #d97706, #fbbf24); -webkit-background-clip: text; -webkit-text-fill-color: transparent; line-height: 1; }
