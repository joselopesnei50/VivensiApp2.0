...
<head>
    ...
    <title>Vivensi - Recuperar Senha</title>
    ...
    <style>
        ...
        .card { width: 100%; max-width: 460px; background:#fff; border-radius: 24px; padding: 44px; border: 1px solid rgba(0,0,0,0.03); box-shadow: 0 10px 40px rgba(0,0,0,0.06); }
...
<div class="wrap">
    <div class="card">
        ...
        @if(session('status'))
            <div class="msg ok"><i class="fas fa-check-circle"></i> {{ session('status') }}</div>
        @endif
        ...
        <div style="margin-top: 14px; color:#94a3b8; font-size:0.85rem; line-height:1.4;">
            Dica: verifique também sua caixa de spam/lixo eletrônico. O link tem validade limitada.
        </div>
