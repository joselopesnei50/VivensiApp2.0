...
Route::middleware(['auth', 'subscription'])->group(function () {
    ...
    Route::middleware('can:access-manager')->group(function () {
        ...
        Route::delete('/prospecting/bulk-delete',   [App\Http\Controllers\ProspectingController::class, 'bulkDestroy'])->name('prospecting.bulk-delete')->middleware('throttle:web_write');
