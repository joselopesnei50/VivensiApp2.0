...
class SecurityHeaders
{
    ...
    private function buildCsp(): string
    {
        ...
        $directives = [
            "default-src 'self'",
            "script-src 'self' https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https://www.googletagmanager.com https://connect.facebook.net 'unsafe-inline'",
            ...
            "connect-src 'self' {$wsOrigin} https://viacep.com.br https://*.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com https://www.facebook.com https://connect.facebook.net",
            "object-src 'none'",
