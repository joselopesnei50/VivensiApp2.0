...
class EmailContactListController extends Controller
{
    public function index()
    {
        $lists = EmailContactList::where('tenant_id', auth()->user()->tenant_id)
            ...
            ->paginate(15);
        return view('admin.email_campaigns.lists.index', compact('lists'));
    }

    public function create()
    {
        return view('admin.email_campaigns.lists.create');
    }
    ...
    public function store(Request $request, EmailContactListImportService $importer)
    {
        ...
        Log::info('EmailContactList criada', [
            'list_id'   => $list->id,
    ...
    public function show(EmailContactList $list, Request $request)
    {
        ...
        return view('admin.email_campaigns.lists.show', compact('list', 'contacts', 'stats', 'q'));
    }
    ...
    public function destroy(EmailContactList $list)
    {
        ...
        return redirect()->route('admin.email_campaigns.lists.index')
